class ModalManager {
    ...
    async handleSubmit() {
        try {
            ...
            // Trigger refresh of current tab - mejorado para paginación
            if (window.crmApp) {
    ...
    async setupCompraForm(editingId) {
        try {
            ...
            // Configurar campos condicionales para pagos
            ...
            if (tiposPago) {
                tiposPago.addEventListener('change', (e) => {
                    // Lógica similar a pedidos para manejar pagos parciales
