    ...
    getFormFields(type) {
        const fieldTemplates = {
            ...
            'pedido': `
                ...
                <div class="form-group">
                    <label class="form-label">Observaciones</label>
                    <textarea id="field-PED_OBS" class="form-input" rows="3" 
                            placeholder="Observaciones adicionales sobre el pedido (opcional)"></textarea>
                </div>
            `,
            'compra': `
                <div class="form-group">
            ...
            'tipo-trabajador': `
                <div class="form-group">
                    <label class="form-label">Descripción *</label>
                    <input type="text" id="field-descripcion" class="form-input" required 
                        placeholder="Ej: Administrador, Vendedor, Técnico, Supervisor, etc.">
                    <small style="color: rgba(255,255,255,0.7); font-size: 0.75rem; margin-top: 0.25rem; display: block;">
                        Describe el tipo de trabajo o cargo del empleado
                    </small>
                </div>
            `,
        };
