class CRMApplication {
    ...
    async showTab(tabName) {
        ...
        // Manejar lógica específica por tab
        switch(tabName) {
            case 'dashboard':
                loadDashboard();
                break;
            ...
            case 'entregas':
                ...
                break;
            case 'tipos-contacto':
                loadTable('tipos-contacto');
                break;
            case 'tipos-pago':
                loadTable('tipos-pago');
                break;
            case 'tipos-trabajador':
                loadTable('tipos-trabajador');
                break;
            case 'reportes-ventas':
            case 'reportes-compras':
                // Manejar tabs de reportes
                if (window.reportesManager) {
                    window.reportesManager.onTabChange(tabName);
                }
                break;
        }
